...
let EditorGuard = class EditorGuard {
    async canActivate(context) {
        ...
        if (user.roles.role === role_name_enum_1.RoleNameEnum.ADMIN_ROLE ||
            user.roles.role === role_name_enum_1.RoleNameEnum.SUPER_ADMIN_ROLE ||
            user.roles.role === role_name_enum_1.RoleNameEnum.EDITOR_ROLE) {
            return true;
        }
        throw new system_exception_1.SystemException(error);
    }
